...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "MetaRec@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "MetaRec API";

        private String description = "MetaRec API documentation";
